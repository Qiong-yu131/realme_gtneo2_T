...
#define PROOT_TSK_CRED 2096 /* offsetof(struct task_struct, cred) */
#define PROOT_CRED_UID 20 /* offsetof(struct cred, uid) */
#define PROOT_CRED_EUID 36 /* offsetof(struct cred, euid) */
#define PROOT_CRED_FSUID 44 /* offsetof(struct cred, fsuid) */
