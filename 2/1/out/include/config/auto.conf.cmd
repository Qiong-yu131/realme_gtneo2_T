...
ifneq "$(LD)" "aarch64-linux-androidkernel-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "aarch64-linux-androidkernel-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "aarch64-linux-androidkernel-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-androidkernel --prefix=/GCC/aarch64-linux-android/bin/aarch64-linux-androidkernel- --gcc-toolchain=/GCC/aarch64-linux-android -no-integrated-as  -Wno-misleading-indentation  -Wno-bool-operation -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
endif
ifneq "$(CROSS_COMPILE_COMPAT)" "arm-linux-androidkernel-"
include/config/auto.conf: FORCE
endif
ifneq "$(HOSTCXX)" "g++"
include/config/auto.conf: FORCE
